...
const phase4Checklist = createChecklist(['Attendance', 'Certificate of Completion / Satisfaction (Supplier)', 'Photos', 'SOA / Billing Statement', 'Delivery Receipt', 'Distribution List (Receiving Copy)']);
