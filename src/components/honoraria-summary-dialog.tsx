                ...
                <table style={{ width: '95%', borderCollapse: 'collapse', border: '1px solid black', fontSize: '12px', marginBottom: '24px', margin: '0 auto' }}>
                    <tbody>
                         <tr>
                            ...
                            <td style={{ border: '1px solid black', padding: isForExport ? '0px 8px 4px 8px' : '8px', fontWeight: '600', verticalAlign: 'middle', boxSizing: 'border-box' }}>{honoraria.activityTitle}</td>
                        </tr>
                        <tr>
                            ...
                            <td style={{ border: '1px solid black', padding: isForExport ? '0px 8px 4px 8px' : '8px', fontWeight: '600', verticalAlign: 'middle', boxSizing: 'border-box' }}>{formatCurrency(honoraria.amount)}</td>
                        </tr>
                    </tbody>
                </table>
