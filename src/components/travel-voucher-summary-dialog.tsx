                ...
                <table style={{ width: '95%', borderCollapse: 'collapse', border: '1px solid black', fontSize: '12px', marginBottom: '24px', margin: '0 auto' }}>
                    <tbody>
                         <tr>
                            ...
                            <td style={{ border: '1px solid black', padding: isForExport ? '2px 8px' : '8px', fontWeight: '600', verticalAlign: 'middle', boxSizing: 'border-box' }}><div style={{position: 'relative', top: isForExport ? '-4px' : '0px'}}>{travelVoucher.activityTitle}</div></td>
                        </tr>
                        <tr>
                            ...
                            <td style={{ border: '1px solid black', padding: isForExport ? '2px 8px' : '8px', fontWeight: '600', verticalAlign: 'middle', boxSizing: 'border-box' }}><div style={{position: 'relative', top: isForExport ? '-4px' : '0px'}}>{formatCurrency(travelVoucher.amount)}</div></td>
                        </tr>
                    </tbody>
                </table>
