        ...
        <div ref={ref} style={{ backgroundColor: 'white', color: 'black', fontFamily: 'sans-serif', width: '8.27in', height: '11.69in', padding: '0.25in', boxSizing: 'border-box' }}>
            <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', paddingBottom: '0.25in', boxSizing: 'border-box' }}>
                ...
                <table style={{ width: '95%', borderCollapse: 'collapse', border: '1px solid black', fontSize: '12px', marginBottom: '24px', margin: '0 auto' }}>
                    <tbody>
                         <tr>
                            <td style={{ border: '1px solid black', padding: isForExport ? '0px 8px 4px 8px' : '8px', fontWeight: 'bold', backgroundColor: '#F5F5F5', width: '30%', verticalAlign: 'middle', boxSizing: 'border-box' }}>ACTIVITY / PROGRAM</td>
                            <td style={{ border: '1px solid black', padding: isForExport ? '0px 8px 4px 8px' : '8px', fontWeight: '600', verticalAlign: 'middle', boxSizing: 'border-box' }}>{travelVoucher.activityTitle}</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid black', padding: isForExport ? '0px 8px 4px 8px' : '8px', fontWeight: 'bold', backgroundColor: '#F5F5F5', verticalAlign: 'middle', boxSizing: 'border-box' }}>AMOUNT</td>
                            <td style={{ border: '1px solid black', padding: isForExport ? '0px 8px 4px 8px' : '8px', fontWeight: '600', verticalAlign: 'middle', boxSizing: 'border-box' }}>{formatCurrency(travelVoucher.amount)}</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table style={{ width: '95%', borderCollapse: 'collapse', border: '1px solid black', fontSize: '12px', tableLayout: 'fixed', margin: '0 auto' }}>
                     <thead>
                        <tr style={{ fontWeight: 'bold', backgroundColor: '#E0E0E0' }}>
                            <td style={{ border: '1px solid black', padding: isForExport ? '0px 8px 4px 8px' : '8px', textAlign: 'center', fontSize: '11px', width: '50%', verticalAlign: 'middle', boxSizing: 'border-box' }}>CHECKLIST (Completed Items)</td>
                            <td style={{ border: '1px solid black', padding: isForExport ? '0px 8px 4px 8px' : '8px', textAlign: 'center', fontSize: '11px', width: '25%', verticalAlign: 'middle', boxSizing: 'border-box' }}>SUBMITTED BY</td>
                            <td style={{ border: '1px solid black', padding: isForExport ? '0px 8px 4px 8px' : '8px', textAlign: 'center', fontSize: '11px', width: '25%', verticalAlign: 'middle', boxSizing: 'border-box' }}>RECEIVED BY</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
